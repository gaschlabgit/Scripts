...
os.environ['PERL5LIB'] = '/home/mplace/Projects/convertGene/reference/vcftools_0.1.12b/lib/perl5/site_perl'

pathToRef              = "/home/mplace/Projects/convertGene/reference"

# paths to reference gff files
refDict = {    
           'R64-1-1' : "/home/mplace/Projects/convertGene/reference/S288C_reference_genome_R64-1-1_20110203/saccharomyces_cerevisiae_R64-1-1_20110208.gff",
           'R64-2-1' : "/home/mplace/Projects/convertGene/reference/S288C_reference_genome_R64-2-1_20150113/saccharomyces_cerevisiae_R64-2-1_20150113.gff"           
          }
# paths to reference fasta files
fastaDict = { 'R64-1-1' :   "/home/mplace/Projects/convertGene/reference/S288C_reference_genome_R64-1-1_20110203/S288C_reference_sequence_R64-1-1_20110203.fsa",         
              'R64-2-1' :   "/home/mplace/Projects/convertGene/reference/S288C_reference_genome_R64-2-1_20150113/S288C_reference_sequence_R64-2-1_20150113.fsa"
    }
...
#******************************************************************************    
    ...
    cmdparser.add_argument('-p', '--print',   action='store_true', dest="PRINT",  help='Enter y to print Current list of supported strains.')
    cmdparser.add_argument('-d', '--detail',  action='store_true', dest="DETAIL", help='Enter y to print out detailed program information.')
...
#******************************************************************************    
    ...
    if cmdResults['DETAIL']:
        ...
        print("\t-v VCF file provided by user, the strain names need to be clean up.")
        ...
        print("\t-p Print the currently supported strain list")
        print("\t\tSee Mike Place about adding more strains.\n")
        print("  Dependencies:")
        print("\tPython 3, VCFtools (v0.1.12b), gffutils")
        print("\tMust have vcftools install and have the perl library in the path.\n")

...
"""
Name: unionFasta.py 
Purpose: compare the sequences of 2 fasta files, output sequences found in 
         both files.
Input:  2 fasta files
Output: single fasta file, sequences found in both fasta files 
Author: Mike Place
Date: 2/3/2015
"""
...
def main():
    ...
    cmdparser = argparse.ArgumentParser(description="Compare 2 fasta files & output seq found in both.", prog='unionFasta.py'  )
    ...
    cmdparser.add_argument('-o', '--output', action='store', required='false', dest='OUT', help='Union.fasta')         
